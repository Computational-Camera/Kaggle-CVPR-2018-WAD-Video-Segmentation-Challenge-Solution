...
_DATASETS = {
    'apollo_train_3384': {
        _IM_DIR:
            _DATA_DIR + '/apollo/train_3384',
        _ANN_FN:
            _DATA_DIR + '/apollo/annotations/train.json',
    },
    'cityscape_train_2048': {
        _IM_DIR:
            _DATA_DIR + '/cityscape/train_2048',
        _ANN_FN:
            _DATA_DIR + '/cityscape/annotations/train.json',
    },
